...
import { ConnectionDisplayProps, ProgressState, SettingsValues } from "./shared";
...
export function useClientState(props: ConnectionDisplayProps) {
    ...
    const signalingClient = useRef<SignalingClient>(undefined);
    const peerConnection = useRef<PeerConnection>(undefined);
