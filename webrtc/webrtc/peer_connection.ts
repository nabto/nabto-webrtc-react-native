...
import { ClientMessageTransportSecurityMode, createClientMessageTransport, DeviceConnectionTimeout, MessageTransport, PerfectNegotiation, SignalingEventHandler, SignalingEventHandlerConnection } from "@nabto/webrtc-signaling-util";
...
export async function createPeerConnection(options: PeerConnectionOptions): Promise<PeerConnection> {
    ...
    let signalingConn = options.signalingClient;
